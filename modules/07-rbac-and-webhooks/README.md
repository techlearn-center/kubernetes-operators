# Module 07: RBAC & Admission Webhooks
...
- Understand the core concepts of RBAC & Admission Webhooks
...
### What is RBAC & Admission Webhooks?

RBAC & Admission Webhooks is a fundamental component of Kubernetes Operators from Scratch: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of RBAC & Admission Webhooks like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/07-rbac-and-webhooks/
```
...
```bash
ls modules/07-rbac-and-webhooks/lab/starter/
```
...
cd modules/07-rbac-and-webhooks/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/07-rbac-and-webhooks/validation/validate.sh
```
...
1. What is the main purpose of RBAC & Admission Webhooks?
...
- [ ] Validation script passes: `bash modules/07-rbac-and-webhooks/validation/validate.sh`
...
**Next: [Module 08 →](../08-testing-operators/)**
