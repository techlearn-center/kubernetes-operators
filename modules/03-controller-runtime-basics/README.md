# Module 03: Controller Runtime Basics
...
- Understand the core concepts of Controller Runtime Basics
...
### What is Controller Runtime Basics?

Controller Runtime Basics is a fundamental component of Kubernetes Operators from Scratch: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Controller Runtime Basics like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/03-controller-runtime-basics/
```
...
```bash
ls modules/03-controller-runtime-basics/lab/starter/
```
...
cd modules/03-controller-runtime-basics/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/03-controller-runtime-basics/validation/validate.sh
```
...
1. What is the main purpose of Controller Runtime Basics?
...
- [ ] Validation script passes: `bash modules/03-controller-runtime-basics/validation/validate.sh`
...
**Next: [Module 04 →](../04-operator-sdk-setup/)**
