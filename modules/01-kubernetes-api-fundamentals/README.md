...
- Understand the core concepts of Kubernetes API Fundamentals
...
### What is Kubernetes API Fundamentals?

Kubernetes API Fundamentals is a fundamental component of Kubernetes Operators from Scratch: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Kubernetes API Fundamentals like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/01-kubernetes-api-fundamentals/
```
...
```bash
ls modules/01-kubernetes-api-fundamentals/lab/starter/
```
...
cd modules/01-kubernetes-api-fundamentals/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/01-kubernetes-api-fundamentals/validation/validate.sh
```
...
1. What is the main purpose of Kubernetes API Fundamentals?
...
- [ ] Validation script passes: `bash modules/01-kubernetes-api-fundamentals/validation/validate.sh`
